...
import UserManagerScreen from '../UserManagerScreen.tsx';
import OrderManagerScreen from '../OrderManagerScreen.tsx';
interface TabDef {
  key: string;
  title: string;
...
const TAB_LIST: TabDef[] = [
  ...
  {key: 'users', title: 'Người dùng', component: UserManagerScreen},
  {key: 'orders', title: 'Đơn đặt hàng', component: OrderManagerScreen},
];
